...
public class UserRepositorySqlServerImpl implements UserRepository {
    ...
    public <S extends User> S save(S entity) {
        ...
        if (entity instanceof Reader) {
            ...
            System.out.println(readerEntity.getVersion());
    ...
    @Override
    public <S extends User> Optional<S> findByUsername(String username) {
        if (userRepositorySqlServer.findByUsername(username).isEmpty()) {
            return Optional.empty();
        }else return Optional.of((S) userEntityMapper.toModel(userRepositorySqlServer.findByUsername(username).get()));
    }
